export const projects = [
  ...
  /*    title: 'QGIS Satellite Hub',
    description: "A Python plugin for eco-engineers to easily manage and gather satellite data from several satellite data servers. Used as a plugin within an app called QGIS. ",
      image: '2.png',
      tags: ['Python'],
    source: 'https://publications.lib.chalmers.se/records/fulltext/255145/255145.pdf',
